...
状態: **項目1〜5 完了（genome は執筆・補強とも完了）／次は項目6（animalphysiology の lessons 新規）**
...
- 項目5：genome の図なしブロックを2手で埋めた（2026-08-26）。
  ...
  - 結果、**図なしで1,200字超のブロックは、全部が表を持つ状態**になった
    （図も表も無いブロックは49件だが、いずれも1,000字未満の対比ブロックで意図的に本文のまま）。
...
| 6 | animalphysiology lessons 新規 | 大 | 大（ゼロ→有） | 次はここ |
| 7 | immunology2 デッキ1〜10 | 最大 | 中 | 未 |
